...
`rqmc_vendor_assessment.py` - Uses Sobol sensitivity analysis with RQMC to:
- Analyze the sensitivity of ROSI and ALE to changes in input parameters
- Optimize the decision of which vendor to choose based on the effectiveness of their controls (using either ROSI or ALE)
- Generate sensitivity indices for each input parameter
- Calculate key risk statistics and percentiles for the best performing vendor(s)
...
│   └── output_example_vend_assess.png
├── requirements.txt
├── risk_simulator.py
...
├── x_rqmc_vendor_assessment.json (Generated by rqmc_vendor_assessment.py)
└── x_rqmc_vendor_assessment.png (Generated by rqmc_vendor_assessment.py)
```
...
```json
{
    "before_controls_stats": {
        ...
        "mode": 38101.334109650714,
        "mode_percentage": 3.05,
...
```json
{
    ...
    "sensitivity_results": {
        "EF": {
            "S1": 0.3573421722476149,
            "S1_conf": 0.010901317622304516,
            "ST": 0.3657925056862101,
            "ST_conf": 0.007715407852329051
        },
        "ARO": {
            "S1": 0.5583346608921688,
            "S1_conf": 0.01452524609955382,
            "ST": 0.5673534864586351,
            "ST_conf": 0.01161656347325818
        },
        "cost_variance": {
            "S1": 0.07431662153058312,
            "S1_conf": 0.0057309539478987885,
            "ST": 0.07687384917168154,
            "ST_conf": 0.0016888009659389485
        }
    }
}
```
...
In the following example, we will use the input file `rqmc_vendor_example.csv` to run an RQMC Vendor Assessment and generate a series of statistics and graphs for the given risk scenario.

#### Input File

```csv
id,asset_value,exposure_factor_min,exposure_factor_max,annual_rate_of_occurrence_min,annual_rate_of_occurrence_max,control_reduction_1_min,control_reduction_1_max,control_cost_1,control_reduction_2_min,control_reduction_2_max,control_cost_2,control_reduction_3_min,control_reduction_3_max,control_cost_3,control_reduction_4_min,control_reduction_4_max,control_cost_4
1,500000,0.4,0.6,1.5,2.5,0.2,0.3,10000,0.35,0.65,30000,0.3,0.4,20000,0.45,0.7,35000
```
...
```json
{
    ...
    "vendor_statistics": [
        {
            "vendor_id": 1,
            "control_cost": 10000.0,
            "control_reduction_ranges": [
                0.2,
                0.3
            ],
            "mean_ale_before": 499396.3974979138,
            "median_ale_before": 497176.30623315054,
            "mode_ale_before": 429743.4495716477,
            "mode_ale_before_percentage": 3.692626953125,
            "std_dev_ale_before": 79142.29595459462,
            "ale_before_percentile_1": 356811.86262320384,
            [ ... ]: [ ... ], 
            "ale_before_percentile_99": 665601.3355478693,
            "mean_ale_after": 374482.1738169737,
            "median_ale_after": 371830.63522103097,
            "mode_ale_after": 317608.7300854948,
            "mode_ale_after_percentage": 3.8330078125,
            "std_dev_ale_after": 61093.7356399168,
            "mean_ale_reduction": 0.25013040603974707,
            "first_nonzero_percentile_ale_after": 0.0,
            "first_nonzero_value_ale_after": 220810.43829659442,
            "ale_after_percentile_1": 262991.68023961585,
            [ ... ]: [ ... ],
            "ale_after_percentile_99": 508425.2683606269,
            "mean_rosi": 1149.1422368094013,
            "median_rosi": 1127.2376230514847,
            "mode_rosi": 1085.2995610611233,
            "mode_rosi_percentage": 3.448486328125,
            "std_dev_rosi": 246.01488788385527,
            "rosi_percentile_1": 690.973258169598,
            [ ... ]: [ ... ],
            "rosi_percentile_99": 1733.7340402927382
        },
        {
            [ ... ]
        }
    ...
    "sensitivity_analysis": {
        "EF": {
            "S1": 0.3773813437451192,
            "S1_conf": 0.010764154714513346,
            "ST": 0.3856860352696076,
            "ST_conf": 0.008131045642025698
        },
        "ARO": {
            "S1": 0.5899354889309105,
            "S1_conf": 0.015146742009280869,
            "ST": 0.5982191111445124,
            "ST_conf": 0.010681020304776297
        },
        "control_reduction_1": {
            "S1": 0.0005953592069467735,
            "S1_conf": 0.0005563729320148666,
            "ST": 0.0006153598783079427,
            "ST_conf": 1.9545329686117524e-05
        },
        "control_reduction_2": {
            "S1": 0.011342678285312002,
            "S1_conf": 0.002687833110500722,
            "ST": 0.012114589967502663,
            "ST_conf": 0.00030555297181037366
        },
        "control_reduction_3": {
            "S1": 0.0007427664053666869,
            "S1_conf": 0.0006739479192226224,
            "ST": 0.0008183627789156792,
            "ST_conf": 2.2990984437428106e-05
        },
        "control_reduction_4": {
            "S1": 0.010789299712103463,
            "S1_conf": 0.002066856094123841,
            "ST": 0.011654013360232867,
            "ST_conf": 0.0003110166247164007
        }
    }
}
 ```
...
![Output Example RQMC Vendor Assessment](readme_media/output_example_vend_assess.png)
...
- [x] Add RQMC vendor assessment
- [x] Refactor common functions into common file
- [ ] Refactor output file names to be more consistent and descriptive
